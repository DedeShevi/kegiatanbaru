                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="hidden" name="register_id" class="form-control" value="{{$pembayaran->id}}" id="">
                                        
                                    <input type="text" name="" class="form-control" value="{{$pembayaran->activity->kode_activity}}" id="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
