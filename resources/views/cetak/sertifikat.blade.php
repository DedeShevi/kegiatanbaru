...
<body>
    <div class="content">
        <div class="">
            ...
            <img class="ml-10 -mt-10" width="150px" src="data:image/png;base64, {{DNS2D::getBarcodePNG("192.168.43.163/kegiatanbaru/public/resoult/{$sertifikat->id}",'QRCODE')}}" alt="barcode">
        </div>
    </div>
</body>
</html>